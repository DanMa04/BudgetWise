...
DEFAULT_CATEGORIES = [
    ...
    {"name": "Subscriptions", "icon": "repeat", "color": "#6366F1", "sort_order": 12, "is_fixed": True},
    {"name": "Travel", "icon": "plane", "color": "#0D9488", "sort_order": 13},
    {"name": "Gifts & Donations", "icon": "gift", "color": "#F59E0B", "sort_order": 14},
    {"name": "Car Payment", "icon": "car", "color": "#3B82F6", "sort_order": 15, "is_fixed": True},
    {"name": "Investment Contribution", "icon": "trending-up", "color": "#0F766E", "sort_order": 16},
